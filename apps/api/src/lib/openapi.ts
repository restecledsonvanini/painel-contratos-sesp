...
export function buildOpenApiDocument() {
  const paths: Record<string, unknown> = {
    ...
    [`${API_BASE}/auth/login`]: pathItem('post', 'Login JWT', ['auth']),
    [`${API_BASE}/auth/me`]: pathItem('get', 'Usuário autenticado', ['auth']),
    [`${API_BASE}/usuarios`]: pathItem('get', 'Listar usuários', ['auth']),
